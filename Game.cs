...
namespace Gears
{
    public class Game : GameWindow
    {
        ...
        public string ActiveCameraName = "MainCamera";
        ...
        protected override void OnLoad()
        {
            ...
            scene.MakeGameObject(lightObj1);
            lightObj1.AddComponent<Light>();

            var lightObj2 = new GameObject("light2");
            scene.MakeGameObject(lightObj2);
            lightObj2.AddComponent<Light>();

            var mesh = FindLoadedAssets.FindMesh("UltraCube");

            if (mesh != null)
            {
                cubeObj.GetComponent<MeshFilter>().Mesh = mesh;
                cubeObj2.GetComponent<MeshFilter>().Mesh = mesh;
                cubeObj3.GetComponent<MeshFilter>().Mesh = mesh;
            }
        ...
        protected override void OnRenderFrame(FrameEventArgs args)
        {
            ...
            GameObject? camObj = scene.Find(ActiveCameraName);
            ...
            _forwardPlus.Run(RenderQueue, GetOrCreateDrawMesh, LightManager.AllData, view, projection, invProjection, nearPlane, farPlane);

            foreach (Camera cam in scene.FindAllComponents<Camera>())
            {
        ...
        protected override void OnUpdateFrame(FrameEventArgs args)
        {
            ...
            {
                var camObj = scene.Find(ActiveCameraName).Transform;
        ...
        protected override void OnKeyDown(KeyboardKeyEventArgs e) { base.OnKeyDown(e); scene.OnKeyDown(e); }
        protected override void OnKeyUp(KeyboardKeyEventArgs e) { base.OnKeyUp(e); scene.OnKeyUp(e); }
        protected override void OnMouseDown(MouseButtonEventArgs e) { base.OnMouseDown(e); scene.OnMouseDown(e); }
        protected override void OnMouseUp(MouseButtonEventArgs e) { base.OnMouseUp(e); scene.OnMouseUp(e); }
        protected override void OnMouseMove(MouseMoveEventArgs e) { base.OnMouseMove(e); scene.OnMouseMove(e); }
        protected override void OnMouseWheel(MouseWheelEventArgs e) { base.OnMouseWheel(e); scene.OnMouseWheel(e); }
        ...
        public static void BeginProbeCapture()
        {
            ...
            Instance?.scene.Render(Instance.scene.DeltaTime);
